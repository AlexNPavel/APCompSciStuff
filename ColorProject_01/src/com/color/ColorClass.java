...
public class ColorClass {
    ...
    public static void main(String[] args) {
        ColorClass[] classes = new ColorClass[10000];
...
//        int six = new Random().nextInt(iterations);
        for (int i = 0; i < iterations; i++) {
            ...
            classes[i] = g;
            System.out.println("The random number for iteration " + classes[i].getInstandNbr() + " of " + classes[i].getMyColor().toLowerCase() + " objects is " + classes[i].getMyRandNbr() + ".");
        }
//        int randRand = new Random().nextInt(15);
//        for (int i = 0; i < randRand; i++) {
//            int h = new Random().nextInt(10000);
//            System.out.println("The random number for iteration " + classes[h].getInstandNbr() + " of " + classes[h].getMyColor().toLowerCase() + " objects is " + classes[h].getMyRandNbr() + ".");
//        }
